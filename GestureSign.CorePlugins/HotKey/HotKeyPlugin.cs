...
namespace GestureSign.CorePlugins.HotKey
{
    public class HotKeyPlugin : IPlugin
    {
        ...
        private void SendKeysSeparately(HotKeySettings settings)
        {
            ...
            List<VirtualKeyCode> pressedModifiers = new List<VirtualKeyCode>();
            ...
            try
            {
                ...
                if (settings.Windows)
                {
                    ...
                    pressedModifiers.Add(VirtualKeyCode.LWIN);
                }
                ...
                if (settings.Control)
                {
                    ...
                    pressedModifiers.Add(VirtualKeyCode.LCONTROL);
                }
                ...
                if (settings.Alt)
                {
                    ...
                    pressedModifiers.Add(VirtualKeyCode.LMENU);
                }
                ...
                if (settings.Shift)
                {
                    ...
                    pressedModifiers.Add(VirtualKeyCode.LSHIFT);
                }
            ...
            finally
            {
                for (int i = pressedModifiers.Count - 1; i >= 0; i--)
                    simulator.Keyboard.KeyUp(pressedModifiers[i]).Sleep(30);
            }
        }
        ...
        private void SendShortcutKeys(HotKeySettings settings)
        {
            if (settings.SendByKeybdEvent)
            {
                ...
                List<KeyboardKey> pressedModifiers = new List<KeyboardKey>();
                try
                {
                    // Windows
                    if (settings.Windows)
                    ...
                    {
                        controlKey.Press();
                        pressedModifiers.Add(controlKey);
                    }
