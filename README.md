...
<p align="center">
  <a href="https://github.com/Tomclanc/GestureSignv2/releases/tag/v16.4.65">
...
也可以前往 [Releases](https://github.com/Tomclanc/GestureSignv2/releases/tag/v16.4.65) 下载最新版安装包。

当前版本：

- [GestureSign-V2-16.4.65-x64.msi](https://github.com/Tomclanc/GestureSignv2/releases/download/v16.4.65/GestureSign-V2-16.4.65-x64.msi)
- [GestureSign-V2-16.4.65-portable-x64.zip](https://github.com/Tomclanc/GestureSignv2/releases/download/v16.4.65/GestureSign-V2-16.4.65-portable-x64.zip)
...
- 修复忽略列表的启用状态刷新：点击“停用”或“启用”后，按钮文字及“开/关”状态会立即同步更新。
...
You can also get the latest installer from [Releases](https://github.com/Tomclanc/GestureSignv2/releases/tag/v16.4.65).
...
### What's new in 16.4.65

- Fixed ignored-list state refresh so the Disable/Enable button and On/Off status update immediately after toggling an item.
...
最新のインストーラーは [Releases](https://github.com/Tomclanc/GestureSignv2/releases/tag/v16.4.65) からも入手できます。
...
- 無視リストの有効状態の更新を修正し、「無効化」または「有効化」をクリックした直後にボタン表示とオン／オフ状態が同期するようにしました。
