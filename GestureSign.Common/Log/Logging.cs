    ...
    public class Logging
    {
        ...
        public static bool OpenLogFile()
        {
            ...
            try
            {
                ...
                var sw = new StreamWriterWithTimestamp(new FileStream(_logFilePath, FileMode.Append, FileAccess.Write, FileShare.ReadWrite | FileShare.Delete)) { AutoFlush = true };
                Console.SetOut(sw);
                Console.SetError(sw);
                result = true;
            }
        ...
        private static void CheckLogSize(string logPath)
        {
            ...
            {
                // If another process is rotating or writing the log, keep app startup alive.
            }
        }
    }
}
